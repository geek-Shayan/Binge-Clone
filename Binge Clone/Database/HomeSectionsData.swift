...
var homeSectionsData: Sections = Sections(
    sections: [
        //0
        SectionDataType(
        ...
        SectionDataType(
            ...
            cells: [
                ...
                CellDataType(image: "Sony Ten 1 1", label: "1"),
        ...
        //6
        SectionDataType(
            headerFooter: SupplementaryDataType(header: "Sports 2", footer: "S"),
            cells: [
                CellDataType(image: "image 20", label: "1"),
                CellDataType(image: "image 5",  label: "2"),
                CellDataType(image: "image 16", label: "3"),
...
//var x = homeSectionsData.sections[1].headerFooter.header
//var y = homeSectionsData.sections[3].cells[2].label
